      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
        ...
        {mail ? (
            ...
            <a
              ...
              onClick={async () => {
                try {
                  ...
                  toast.success("Report copied — paste it into the email if the draft is truncated");
                } catch {
                  toast.message("Copy the report, then paste it into the email draft");
                }
              }}
            >
          ...
          <Button
            type="button"
            variant="outline"
            title="Only for xAI API / Console / Imagine API / Voice API"
            onClick={() =>
              toast.message(
                "Email API is only for xAI API, Console, Imagine API, or Voice API. For Grok apps, Copy and paste into ⋮ Report an issue.",
              )
            }
          >
            <Mail className="size-4" aria-hidden />
